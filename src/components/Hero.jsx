...
const Hero = () => {
  return (
    <section className="w-full min-h-screen flex flex-col relative">
      <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-12 pt-16 md:pt-0">
        
        {/* Text Section */}
        <div className="flex flex-col gap-6 w-full md:w-1/2 z-10">
          <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight">
            FIND CLOTHES THAT MATCH YOUR STYLE
          </h1>
          <p className="text-gray-600 text-base md:text-lg w-full md:w-2/3">
            Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.
          </p>
          <button className="bg-black text-white rounded-full h-12 w-40 hover:bg-gray-800 transition">
            Shop Now
          ...
          <div className="flex flex-wrap gap-6 md:gap-12 mt-8">
            <div className="flex flex-col items-start">
              <span className="text-3xl md:text-5xl font-bold">200+</span>
              <span className="text-gray-600 text-sm">International Brands</span>
            </div>
            <div className="flex flex-col items-start">
              <span className="text-3xl md:text-5xl font-bold">2,000+</span>
              <span className="text-gray-600 text-sm">High-Quality Products</span>
            </div>
            <div className="flex flex-col items-start">
              <span className="text-3xl md:text-5xl font-bold">30,000+</span>
              <span className="text-gray-600 text-sm">Happy Customers</span>
            </div>
          </div>
        </div>
        ...
        {/* Image Section */}
        <div className="hidden absolute md:block  h-screen">
          <img src={HeroImg} alt="Hero" className="object-cover w-full h-full" />
        </div>
      </div>

      {/* Brand Logos */}
      <div className="w-full z-10 p-6 md:p-10 bg-black flex flex-wrap items-center justify-center gap-6 md:gap-20 mt-12">
        <span className="text-white text-xl md:text-3xl font-serif tracking-widest uppercase">VERSACE</span>
        <span className="text-white text-xl md:text-3xl font-sans font-bold uppercase tracking-wider">ZARA</span>
        <span className="text-white text-xl md:text-3xl font-serif italic tracking-wide uppercase">GUCCI</span>
        <span className="text-white text-xl md:text-3xl font-sans tracking-tight uppercase">PRADA</span>
        <span className="text-white text-xl md:text-3xl font-light font-sans tracking-normal capitalize">Calvin Klein</span>
      </div>
    </section>
  );
};
